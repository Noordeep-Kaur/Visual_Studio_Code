...
namespace Bus.Models
{
    ...
    public partial class BusReservationEntities : DbContext
    {
        ...
        public virtual int proc_addTicketDetail(Nullable<int> bid, Nullable<int> buid, string fromloc, string toloc, Nullable<System.DateTime> fromDate, Nullable<System.DateTime> todate, Nullable<System.TimeSpan> fromTime, Nullable<System.TimeSpan> toTime, Nullable<int> seats, Nullable<int> fare)
        {
            var bidParameter = bid.HasValue ?
                new ObjectParameter("bid", bid) :
                new ObjectParameter("bid", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("proc_addTicketDetail", bidParameter, buidParameter, fromlocParameter, tolocParameter, fromDateParameter, todateParameter, fromTimeParameter, toTimeParameter, seatsParameter, fareParameter);
        }
    
        public virtual ObjectResult<proc_TicketFetching_Result> proc_TicketFetching(Nullable<int> id)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<proc_TicketFetching_Result>("proc_TicketFetching", idParameter);
        }
    }
}
